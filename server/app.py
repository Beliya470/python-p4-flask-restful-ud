...
from models import db, Newsletter  # If Newsletter is not defined in models, you should define it appropriately.
...
class NewsletterByID(Resource):
    def get(self, id):
        record = Newsletter.query.filter_by(id=id).first_or_404()
